...
public class Player {
    ...
    private void UpdatePhysics() {
        ...
        rigidbody.UpdateVelocityWithForce( forceDirection, 20.0f, Time.deltaTime );
    ...
    public void Update() {
        ...
        Rotation = DevMath.DevMath.RadToDeg( DevMath.Vector2.Angle( new DevMath.Vector2( 0.0f, 0.0f ), mouseDir ) );
