...
public class Enemy {
    ...
    public void Render() {
        ...
        Matrix4x4 rotation = Matrix4x4.Rotate( Quaternion.Euler( 0f, 0f, Rotation ) );
    ...
    public void Update(Player player) {
        ...
        if( distanceToPlayer < CHASE_DISTANCE ) {
            ...
            Rotation = DevMath.DevMath.RadToDeg( DevMath.Vector2.Angle( new DevMath.Vector2( 0.0f, 0.0f ), moveDirection ) );
        }
    }
}
